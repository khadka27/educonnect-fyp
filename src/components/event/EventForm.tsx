...
const eventSchema = yup.object().shape({
  ...
  virtualEventLink: yup.string().when("virtualEvent", {
    ...
    then: (schema) =>
      schema
        .required("Virtual event link is required")
...
export function EventForm() {
  ...
  useEffect(() => {
    ...
    const earlyBirdFields = formValues.earlyBirdDiscount
      ? ["earlyBirdDeadline", "earlyBirdPercentage"]
      : [];
  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6  bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950 dark:to-teal-900">
      <motion.div
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-green-900 darker:text-white ">
              Create New Event
            </h1>
              ...
              <CardHeader className="pb-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>
                      Create an engaging event for your audience
                    </CardDescription>
                  </div>
                  <div className="flex items-center gap-2">
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  ...
                                  className="min-h-[120px] resize-y transition-all duration-200 focus:ring-2 focus:ring-emerald-500/20"
                                  {...field}
                                />
                              </FormControl>
                              <FormDescription>
                                Markdown formatting is supported. Be descriptive
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Categorizing your event helps with discovery
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              <AnimatePresence>
                                {form.watch("tags")?.map((tag) => (
                                  ...
                                  >
                                    <Badge className="flex items-center gap-1 px-3 py-1 bg-emerald-100 text-emerald-800 hover:bg-emerald-200">
                                      <span>{tag}</span>
                                      <button
                                        type="button"
                                        onClick={() => handleRemoveTag(tag)}
                                        className="text-xs rounded-full hover:bg-emerald-300/20 p-1"
                                      >
                                        <X className="h-3 w-3" />
                                      </button>
                                    </Badge>
                            ...
                            <p className="text-sm text-muted-foreground mt-2">
                              Tags help attendees find your event
                            </p>
                          </div>
                        </div>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Last day attendees can register
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>
                                  Attendees can join online via a meeting link
                                </FormDescription>
                              </div>
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Zoom, Google Meet, Microsoft Teams, or any
                                  other meeting link
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                      ...
                      <TabsContent value="pricing" className="space-y-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                Free events are open to all, premium events
                                require payment
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                  ...
                                  <div className="space-y-1 leading-none">
                                    ...
                                    <FormDescription>
                                      Special pricing for early registrations
                                    </FormDescription>
                                  </div>
                                </FormItem>
                              )}
                        ...
                        <div className="rounded-md border p-4 bg-emerald-50">
                          ...
                          <p className="text-sm text-emerald-700">
                            Premium events require payment processing setup.
                            Make sure your payment gateway is configured in your
                            account settings.
                          </p>
                        </div>
                      </TabsContent>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                Alternatively, provide a URL for your event
                                banner image
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        {form.watch("category") && (
                          <Badge
                            variant="outline"
                            className="mt-2 border-emerald-200 text-emerald-700"
                          >
                            {form.watch("category")}
                          </Badge>
                        )}
                          ...
                          <div className="space-y-1">
                            ...
                            {form.watch("earlyBirdDiscount") && (
                              <div className="text-xs text-muted-foreground">
                                Early bird discount:{" "}
                                {form.watch("earlyBirdPercentage")}% off until{" "}
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Your event has been created and is now ready to be shared.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            ...
            <Button
              ...
              className="sm:flex-1 border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700"
            >
